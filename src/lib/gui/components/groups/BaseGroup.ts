...
export class BaseGroup extends Field implements GUIAddableInterface {
  ...
  addTitle: GUIAddableInterface["addTitle"] = (hSize, text, doAlignCenter) => {
    const title = new components.Title(this.gui, hSize, text, doAlignCenter);
  ...
  addColourBoxes: GUIAddableInterface["addColourBoxes"] = (
    ...
    this.gui.addController(colourBoxes);
  ...
  addMultiColourBoxes: GUIAddableInterface["addMultiColourBoxes"] = (
    ...
    this.gui.addController(multiColourBoxes);
