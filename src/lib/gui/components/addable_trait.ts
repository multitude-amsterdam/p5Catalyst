...
import type { GUIAddableInterface } from 'src/lib/types/gui_interface';
import type {
	controllerCallback,
	valueCallback,
	setupCallback,
...
export function Addable<TBase extends Constructor<Attachable>>(Base: TBase) {
	return class extends Base implements GUIAddableInterface {
